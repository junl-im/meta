...
## 1.15.6 GomFox Reach 3.0 Research Engine
- 질문 분석 및 5개 검색어 확장
- Google 검색 실행 보조
- 최대 6개 공개 URL Reader 일괄 수집
- 직접 붙여넣기 출처 추가
- 내용 유사도 기반 중복 출처 제거
- 출처별 날짜·도메인·품질 휴리스틱
- 핵심 주장 추출 및 독립 출처 지지 그룹화
- 숫자·날짜 상충 신호 탐지
- 글쓰기용 근거팩과 출처 없는 문장 차단 원칙
- 기존 AI 글 다듬기 exact-source typing 계약 변경 없음
